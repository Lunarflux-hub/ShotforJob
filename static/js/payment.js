/**
 * Логика страницы /payment/ — покупка пакетов генераций через Robokassa.
...
(() => {
    ...
    const robokassaForm = document.getElementById("paymentRobokassaForm");
    ...
    async function submitPayment() {
        ...
        try {
            ...
            // Собираем и отправляем форму на Robokassa
            robokassaForm.action = data.action_url;
            robokassaForm.method = data.method || "POST";
            robokassaForm.innerHTML = "";
            ...
            showMessage("Перенаправляем на страницу оплаты Robokassa…", "info");
